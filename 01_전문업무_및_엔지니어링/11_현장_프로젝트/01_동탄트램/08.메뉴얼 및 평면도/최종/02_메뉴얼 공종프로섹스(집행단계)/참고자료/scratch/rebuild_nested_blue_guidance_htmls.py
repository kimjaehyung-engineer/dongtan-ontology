...
manuals_nested_blue = [
    {
        ...
        'box_title': '발주전략 KOM 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 규정에 의거하여 상부강화노반 시공 발주 전 발주처 시방서 검토, 3D BIM 도면 대조 및 리스크 관리계획을 선제 수립하고 발주전략 KICK-OFF 미팅 결재를 최종 수검받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '철도보호지구 행위신고 현장 실무 개요',
        'box_desc': '본 지침서는 철도안전법 제45조 및 시행령 제44조에 의거하여 궤도 중심 30m 이내 철도보호지구 공사에 대한 법정 행위신고서를 관할 철도운영기관에 제출하고 운행선안전관리자 상주 배치를 완료하여 최종 공사 승인을 받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '착수전 측량 Data 확인 현장 실무 개요',
        'box_desc': '본 지침서는 공공측량 작업규정 및 KCS 47 10 25에 의거하여 국가 CP/TBM 기준점을 인수하고 GRS80 세계측지계 수준측량(폐합오차 ≤ 5mm√K) 및 현장 인조점 3개소 매설을 완수하여 3D BIM 측량 성과를 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '지장물이설 협의 현장 실무 개요',
        'box_desc': '본 지침서는 지하안전관리에 관한 특별법 제23조에 의거하여 GPR 지중 탐사 및 인력 줄파기(1.5m)를 시행하고 점용기관 1:1 현장 입회하에 지하 매설물 이설 방호를 완수하여 지장물 이설 완료 승인을 최종 받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '용지보상RISK 검토 현장 실무 개요',
        'box_desc': '본 지침서는 토지보상법에 의거하여 용지보상 미보상 사유지 경계를 현출하고 높이 1.8m 가설 펜스 차단 및 3D 우회 토공 동선을 수립하여 공정 지연 리스크 해징 승인을 최종 받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '최고의 팀 만들기 지원 현장 실무 개요',
        'box_desc': '본 지침서는 건설산업기본법 상생협력 규정에 의거하여 토공 전문 기술자 1:1 전담 배치, 발주·감리·시공 3자 주간 소통 회의 및 근로자 복지 지원을 완수하여 One-Team 조직 결재를 최종 수검받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '시공계획서 수립 승인 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 시행령 제89조에 의거하여 KCS 47 10 25 다짐 규정이 포함된 시공계획서를 작성하고 공사 착수 14일 전 책임감리단 기술 검토를 거쳐 최종 시공 승인을 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '작업조 편성 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 및 건설근로자법에 의거하여 공종별 전담 기술 수첩 및 건설기계 조종원 면허를 1:1 검증하고 일일 음주 측정과 TBM을 완료하여 작업조 조직표 서면 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '장비 수급 계획 현장 실무 개요',
        'box_desc': '본 지침서는 건설기계관리법 제13조에 의거하여 자중 10ton+ 강동 롤러, 타이어 롤러 및 3D GPS 모터그레이더 정기검사증을 검수하고 장비 후방 센서 테스트를 완료하여 반입 허가 결재를 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '노반 재료 입도 DB 확보 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 쇄석 입도 규정에 의거하여 쇄석 골재 최대입경(50mm 이하), #200체 통과량(5% 이하) 및 수정다짐 CBR(30% 이상)을 검측하고 노반 재료 입도 DB 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '사토장 / 토사 수급 계획 확인 현장 실무 개요',
        'box_desc': '본 지침서는 토양환경보전법 및 국토계획법에 의거하여 화성시 정식 사토장 인허가를 확인하고 최대건조밀도 γd max ≥ 1.90g/cm³ 및 토양오염 8개 항목 검사를 완수하여 사토 계획 서면 승인을 최종 받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '배수 처리 계획 수립 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 임시 배수 시설 시방에 의거하여 성토 사면 가배수로(0.6×0.6m), 가침사지 2개소 및 HDPE 유공관(Ø200mm, 구배 ≥0.5%)을 설치하여 배수 처리 계획 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '안전관리계획 수립 승인 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 제62조에 의거하여 작성된 안전관리계획서를 국토안전관리원에 제출하여 적정 심사를 필하고 CSI 건설공사 안전관리 종합망 등록을 완료하여 감리 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '품질관리계획 수립 승인 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 제55조에 의거하여 노반 다짐도(500m³당 1회), K30(2,000m²당 1회) 및 Ev2(1,000m²당 1회) 품질 시험 빈도를 수립하고 현장 시험실 교정을 완수하여 품질관리계획 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '환경관리계획 수립 승인 현장 실무 개요',
        'box_desc': '본 지침서는 대기환경보전법 제44조 및 소음진동관리법에 의거하여 지자체 비산먼지 발생사업 신고를 필하고 이동식 세륜기(깊이 1.2m) 및 가설 방음벽(3m) 가동을 완수하여 환경관리계획 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '교통소통 대책 수립 승인 현장 실무 개요',
        'box_desc': '본 지침서는 도로교통법 제69조 및 도로법에 의거하여 동탄경찰서 교통안전 심의를 필하고 차선 점용 허가증 수령 및 전담 안전 신호수(2인 2조) 배치를 완수하여 교통소통 대책 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '하도급 검토 승인 현장 실무 개요',
        'box_desc': '본 지침서는 건설산업기본법 제29조에 의거하여 토공 전문건설업 면허 및 하도급율(82% 이상) 적정성을 심사하고 노무비 지급 전용계좌 개설을 완료하여 하도급 계약 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '자재승인 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 자재 검수 규정에 의거하여 KS F 2527 쇄석골재, HDPE 유공관 및 부직포(200g/m²) 공인시험기관 성적서를 수속하고 현장 반입 검수를 완수하여 자재 승인 통보서를 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '시험다짐 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 현장 시험 규정에 의거하여 50m 시험 구간에 쇄석 30cm를 포설하고 패스별 침하량(Δh ≤ 1mm)을 실측하여 강동 롤러 4~6회 다짐 횟수를 확정받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '원지반 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 원지반 지침에 의거하여 유기질 표토(15~30cm) 제거 및 전압 다짐을 시행하고 원지반 K30 ≥ 70 MN/m³ 시험과 덤프트럭 펌핑 점검을 완수하여 원지반 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '하부노반 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 하부노반 규정에 의거하여 층두께 30cm 이하 포설 다짐, 들밀도 다짐도 ≥ 90% (KS F 2311) 및 K30 ≥ 90 MN/m³ 지비력을 검측하여 하부노반 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '상부노반 시공 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 상부노반 시방에 의거하여 토사 30cm 포설 다짐, 맹암거 투수성 부직포(200g/m²) 및 HDPE 유공관(Ø200mm, 천공 상향) 부설을 완수하여 상부노반 매몰 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '상부강화노반 시공 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 강화노반 쇄석 규정에 의거하여 3D GPS 쇄석(50mm) 30cm 포설, 최적함수비 OMC 분무 살수 및 강동 4회/타이어 2회 조합 다짐을 완수하여 마무리면 표고 오차 ±10mm 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '다짐 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 다짐 수칙에 의거하여 노반 다짐도 ≥ 95% (KS F 2311), 평판재하시험 K30 ≥ 110 MN/m³ 및 동적변형계수 Ev2 ≥ 60 MPa (Ev2/Ev1 ≤ 2.2) 3대 공학 수치를 실측 검측하여 최종 다짐 승인을 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '평판재하시험 현장 실무 개요',
        'box_desc': '본 지침서는 KS F 2310 규정에 의거하여 Ø300mm 재하판 산모래 밀착, 15t 유압 잭 하중 재하 및 1.25mm 침하 P-S 하중-침하 곡선을 산출하여 K30 ≥ 110 MN/m³ 성적표 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '강성 검측(K30, EV2) 현장 실무 개요',
        'box_desc': '본 지침서는 DIN 18134 및 KCS 47 10 25에 의거하여 LWD 동적 평판재하시험을 1,000m²당 1회 시행하고 2차 변형계수 Ev2 ≥ 60 MPa 및 변형계수 비율 Ev2/Ev1 ≤ 2.2를 검측하여 강성 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '평탄성 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 평탄성 규정에 의거하여 3m 알루미늄 직선자 20m 간격 연속 측정 및 최대 갭 오차 ±10mm 이내 통제를 확인하고 요철 부위 삭평 재다짐을 완수하여 평탄성 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '노반 종 횡단 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 측량 지침에 의거하여 GRS80 광학 토탈스테이션으로 10m 간격 중심선(X,Y) 및 표고(Z) 오차 ±10mm를 실측하여 3D BIM 좌표 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '부적합 사항 조치 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 NCR 절차에 의거하여 감리단 부적합 통지서 수령 후 해당 구역 표면 15cm 파쇄, OMC 살수 재다짐 및 1:1 재검측을 완수하여 NCR 서면 종결 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '사면 다짐 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 성토 사면 규정에 의거하여 사면 경사(1:1.5 이하) 측량, 사면 다짐도 ≥ 90% 검측 및 식생 거적 덮개(Jute Mat) 30cm 겹침 부설을 완수하여 사면 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '배수시설 시공 검측 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 배수 구조물 시방에 의거하여 U형 측구(0.4×0.4m), 집수정 인버트 모타르 사춤 및 주철 그레이팅 덮개 체결과 담수 통수 시험을 완수하여 배수시설 검측 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '완성면 보호 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 완성면 유지관리 규정에 의거하여 통제 바리케이트(중장비 진입 100% 차단), 미세 분무 살수 및 비 비닐 덮개 부설을 완수하여 완성면 보호 대장 서면 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '공사일지 작성 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 시행규칙에 의거하여 일일 투입 인원, 장비, 성토 물량(m³) 및 품질 시험 성적을 기록하고 CSI 건설공사 관리 시스템 전산 등록과 감리 일일 서면 직인 결재를 완수하기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '검측 및 승인 관리 현장 실무 개요',
        'box_desc': '본 지침서는 건설기술진흥법 및 KCS 47 10 25에 의거하여 공사 착수 24시간 전 검측 요청서 제출, 책임감리원 1:1 현장 입회 및 16개 항목 체크리스트 서명을 완료하여 총괄 검측 대장 승인을 최종 교부받기 위한 실무 지침입니다.',
        'steps': [
    ...
    },
    {
        ...
        'box_title': '토공 마무리면 인계 현장 실무 개요',
        'box_desc': '본 지침서는 KCS 47 10 25 최종 인계인수 규정에 의거하여 토공 시공사-궤도 시공사-책임감리단 3자 합동 현측(표고 ±10mm, K30 ≥ 110, Ev2 ≥ 60)을 실시하고 인계인수 합의서 서명을 완료하여 상부강화노반 완공을 최종 통보하기 위한 실무 지침입니다.',
        'steps': [
...
print(f"최종 2중 카드 파란색 개요 규격 재건축 대상 개수: {len(manuals_nested_blue)}")

for item in manuals_nested_blue:
    ...
    # 이미지와 100% 동일한 2중 네스티드 카드 구조 (Outer Blue Soft Card + Inner White Card)
    nested_blue_html = f"""<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    ...
    <div class="p-6 sm:p-10 space-y-10">
        ...
        <div class="bg-blue-50/70 border border-blue-200/80 p-6 sm:p-8 rounded-2xl text-slate-800 shadow-sm space-y-4">
            <h4 class="font-bold text-base sm:text-lg text-slate-900 flex items-center gap-2 m-0">
                <span class="text-base">💡</span> {box_title}
            </h4>
...
<script>
    ...
    with open(target_file, 'w', encoding='utf-8') as f:
        f.write(nested_blue_html)

print("SUCCESS: 35개 상부강화노반 수행지침서 HTML 파일이 이미지와 100% 동일한 2중 파란색 네스티드 카드 구조로 최종 완벽 재건축되었습니다!")
