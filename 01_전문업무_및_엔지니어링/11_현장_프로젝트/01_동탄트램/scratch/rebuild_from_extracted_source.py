...
output_html_path = r'c:\Users\sskjh\antigravity\01_전문업무_및_엔지니어링\11_현장_프로젝트\01_동탄트램\09.공정표\동탄트램_Time_Chainage_공정표_대시보드.html'
...
# Strip import statements from top of App.jsx as CDN globals will be used
app_jsx_clean = re.sub(r'import\s+.*?;?\n', '', app_jsx)
app_jsx_clean = re.sub(r'export\s+default\s+App;?', '', app_jsx_clean)

# Combine Recharts destructured variables for CDN version
recharts_helpers = """
...
print(f"Created restored standalone Time-Chainage Dashboard HTML ({os.path.getsize(output_html_path)} bytes)!")
