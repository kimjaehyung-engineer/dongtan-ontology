...
# 1. Prepare HTML for Container Views
resource_view_html = """  <!-- ============================================================================ -->
...
# Inject right after <div class="app-layout">...</div>
pattern_layout_end = r'</div>\s*<!-- 대시보드 풋터 -->'

if re.search(pattern_layout_end, content):
    content = re.sub(pattern_layout_end, '</div>\n\n' + resource_view_html + '\n  <!-- 대시보드 풋터 -->', content, count=1)
    print("Injected container-resource-view and container-evm-view HTML into Body DOM!")

with open(f_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("Finished fixing views HTML injection in V1 HTML!")
