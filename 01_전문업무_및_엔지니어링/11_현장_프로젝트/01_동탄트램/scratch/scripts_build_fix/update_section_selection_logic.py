...
# Replace selectConstructionSection function
...
new_select = """function selectConstructionSection(sec) {
  ...
  if (matchedIntersections.length > 0) {
    matchedIntersections.forEach(item => {
      ...
      ring1.setAttribute("cx", pos.x); ring1.setAttribute("cy", pos.y);
      ...
      ring2.setAttribute("cx", pos.x); ring2.setAttribute("cy", pos.y);
      ...
      beacon.setAttribute("cx", pos.x); beacon.setAttribute("cy", pos.y);
      beacon.setAttribute("r", "2.8"); beacon.setAttribute("fill", "#ffffff");
      beacon.setAttribute("stroke", glowColor); beacon.setAttribute("stroke-width", "1.2");
...
if old_select:
    ...
    print("Replaced selectConstructionSection with enhanced logic")

with open(path, 'w', encoding='utf-8') as f:
    f.write(text)

print("Updated section selection logic successfully!")
