...
<head>
  ...
  <title>동탄트램 Time-Chainage 대시보드 (세로형 시공구간 필터 트레이)</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* 메인 3열 레이아웃 (세로 필터 트레이 포함) */
    .app-layout {
      height: calc(100vh - 56px); display: flex; width: 100vw;
    }

    /* 1열: 세로형 시공구간 필터 트레이 (Vertical Section Filter Tray) */
    .v-filter-tray {
...
<body>
  ...
  <header class="app-header">
    <div class="brand-title">
      ...
      <span class="brand-tag">세로형 시공구간 선택 패널 탑재</span>
    </div>
  ...
  <div class="app-layout">
    ...
    <main class="main-view">
      <div class="chart-box">
        <div class="chart-topbar">
          <div class="chart-title-text" id="chart-title-text">
            📍 Time-Chainage 2D 다이어그램 (선택한 시공구간 표출)
          </div>
      ...
      <div class="summary-bar">
        <div class="stat-pill">선택한 시공구간: <strong id="stat-group-count">28개 구간</strong></div>
        <div class="stat-pill">세부 항목: <strong id="stat-subsec-count">123개</strong></div>
        <div class="stat-pill">표출 필터: <strong id="stat-filter-label">전체 선택됨</strong></div>
  ...
  <script>
    ...
    let currentZone = 'ALL';
    let currentCategoryTab = 'ALL'; // 'ALL', '일반부지', '트램부지'
    let selectedSplitKeys = new Set(); // Multi-selected split keys
...
print("Successfully generated Vertical Section Filter Tray Dashboard HTML!")
