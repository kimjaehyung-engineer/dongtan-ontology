...
<head>
  ...
  <title>동탄트램 Time-Chainage 대시보드 (고시가성 차트 그리드 완벽 보장)</title>
...
<body>
  ...
  <header class="app-header">
    <div class="brand-title">
      控制 📍 동탄도시철도 트램 Time-Chainage 대시보드
      <span class="brand-tag">선택 시공구간 100% 줌인 & 선명한 차트 그리드 보장</span>
    </div>
      ...
      <div class="chart-box">
        <div class="chart-topbar">
          <div class="chart-title-text" id="chart-title-text">
            📍 Time-Chainage 2D 다이어그램 (선택 시공구간 100% 줌인 뷰)
          </div>
...
print("Successfully fixed SVG Chart Visibility and Render Defense Logic!")
