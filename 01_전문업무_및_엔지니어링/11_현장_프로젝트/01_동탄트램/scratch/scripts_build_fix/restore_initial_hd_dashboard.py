...
<head>
  ...
  <title>동탄트램 Time-Chainage 공정표 대시보드 (원상 완벽 복원)</title>
...
<body>
  ...
  <header class="app-header">
    <div class="brand-title">
      ...
      <span class="brand-tag">원상 복원 & 선명 2D 공정 다이어그램</span>
    </div>
  ...
  <script>
    ...
    // 3열: 100% 무결성 방어 2D SVG Time-Chainage 엔진 (원상 복원)
    function renderSVG() {
      ...
      // 3. 5대 세부 공종별 컬러 코딩 라인 표출 (완벽 원상 복원)
      if (currentViewMode === 'SPLITS') {
        ...
        targetSplitsToDraw.forEach((g, gIdx) => {
          g.items.forEach((item, itemIdx) => {
            ...
            // 공정선 시공연도 산정 (2027.6년 ~ 2031.5년 안착)
...
print("✓ Successfully restored initial high-definition 2D Time-Chainage Diagram Dashboard!")
