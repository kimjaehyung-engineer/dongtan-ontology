...
# ENRICHED GUIDELINE HTML CONTENT
gui_enriched_html = f"""<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<div class="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 sm:p-10 space-y-10">
        ...
        <!-- 🔥 세부 실무 가이드 & 사진 & 2D SVG -->
        <div class="space-y-8">
            <h2 class="text-xl font-bold text-slate-900 border-b-2 border-indigo-600 pb-2">엔지니어링 상세 실무 지침 & 1:1 2D 그림</h2>
            ...
            <div class="bg-white p-6 rounded-2xl border border-indigo-200 shadow-sm space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 bg-white p-4 rounded-lg border border-indigo-200">
                        <div>
                            ...
                            <p class="text-slate-700 leading-relaxed">
                                검교정 성적서에 기재된 일련번호(Serial No.)와 실제 투입되는 광융착기 및 OTDR 명판의 S/N가 일치하는지 대조해야 서류 위조나 타 장비 투입을 막을 수 있습니다.
                            </p>
                        </div>
                        <div>
                            <span class="font-bold text-indigo-900 block mb-1">🔪 2. 광절단기 刃(날) 마모 점검</span>
                            <p class="text-slate-700 leading-relaxed">
                                광케이블 접속 불량의 80%는 절단기 刃 마모로 발생합니다. 절단 각도(90°±0.5°) 유지 여부와 예비 배터리 팩 충전을 사전 확인해야 합니다.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step2', 'STEP 2 자원 투입 검교정 승인 2D 시공 도식')">
                    <svg id="svg_step2" viewBox="0 0 520 180" width="100%" height="180" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="400" y="50" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">📑 현장 투입 사전 승인</text>
                        <text x="315" y="78" font-size="11" font-weight="bold" fill="#334155">• 자재 야적장 5대 환경 통과</text>
                        <text x="315" y="100" font-size="11" font-weight="bold" fill="#334155">• 교통통제 신호수 2인 배치</text>
                        <text x="400" y="132" font-size="11" font-weight="black" fill="#047857" text-anchor="middle">✔ 자원 투입 검토 완료</text>
                    </svg>
                </div>
            </div>
...
# Overwrite Guideline HTML Files
        ...
        for f in os.listdir(gui_dir):
            if f.endswith('.html'):
                ...
                with open(fp, 'w', encoding='utf-8') as file_obj:
                    file_obj.write(gui_enriched_html)
                print(f"   ✓ [ENRICHED GUIDELINE APPLIED] -> {fn}/수행지침/{f}")

print("\n🎉 SUCCESSFULLY EXPANDED ALL WBS 9000-2-8 GUIDELINE HTMLs WITH RICH PRACTICAL ENGINEERING DETAILS!")
