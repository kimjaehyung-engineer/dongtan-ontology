...
try:
    ...
    for b in excel.Workbooks:
        if "매뉴얼 BODY" in b.Name:
            wb = b
            break
            
    if wb:
        ws = wb.Worksheets("통신분야")
        ...
        wb.Save()
        print("🎉 LIVE OPEN EXCEL V4 WORKBOOK UPDATED & SAVED SUCCESSFULLY VIA WIN32COM!")
    else:
        print("Target workbook not found in active Excel instance.")
