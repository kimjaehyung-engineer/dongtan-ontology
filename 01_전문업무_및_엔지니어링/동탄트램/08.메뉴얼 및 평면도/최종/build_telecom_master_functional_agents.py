...
# Functional Agent Assignment Mapping based on Telecom Engineering Functions
agent_map = {
    # Agent 1: 통신 기획·품질관리·법정인허가 전문 에이전트 (9개 Activity)
    1: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    2: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    7: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    10: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    11: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    28: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    29: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    31: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),
    32: ("Agent 1 (통신 기획·품질관리·법정인허가 전문)", "통신 기획 및 법정 준공인허가 관리"),

    # Agent 2: 타분야 인터페이스·선행공정·운영사 협의 전문 에이전트 (7개 Activity)
    3: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    4: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    5: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    6: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    9: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    14: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),
    22: ("Agent 2 (인터페이스·선행공정·운영사협의 전문)", "타 분야 인터페이스 및 선행공정 관리"),

    # Agent 3: 통신설비 제작·자재검수·관제시공 전문 에이전트 (7개 Activity)
    8: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    12: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    13: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    15: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    16: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    17: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),
    18: ("Agent 3 (통신설비 제작·자재검수·관제시공 전문)", "통신 자재 검수 및 설비 현장 시공"),

    # Agent 4: 통신 시험·통합시운전·LTE-R 검증 전문 에이전트 (9개 Activity)
    19: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    20: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    21: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    23: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    24: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    25: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    26: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    27: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
    30: ("Agent 4 (통신 시험·통합시운전·LTE-R 검증 전문)", "통신 시험, 시운전 및 통합 검증"),
}
...
for act in activities:
    ...
    idx = act['idx']
    agent_name, agent_category = agent_map.get(idx, ("Agent 1 (통신 전문)", "통신 시공 관리"))
    
    matched_folder_name = None
    for ef in existing_folders:
        if ef.startswith(f"{idx}_") or ef.startswith(f"{code}_") or safe_name in ef or name in ef:
            matched_folder_name = ef
            break
            
    if not matched_folder_name:
        matched_folder_name = f"{idx}_{safe_name}"
...
"""
    ...
    # Save HTML files with safe_name
    for fname in [f"{safe_name}_표준서.html", f"{code}_{safe_name}_표준서.html"]:
        with open(os.path.join(std_dir, fname), 'w', encoding='utf-8') as f:
            f.write(std_html)

    for fname in [f"{safe_name}_수행지침.html", f"{code}_{safe_name}_수행지침.html"]:
        with open(os.path.join(gui_dir, fname), 'w', encoding='utf-8') as f:
            f.write(gui_html)

    for fname in [f"{safe_name}_체크리스트.html", f"{code}_{safe_name}_체크리스트.html"]:
        with open(os.path.join(chk_dir, fname), 'w', encoding='utf-8') as f:
            f.write(chk_html)

print("\n🎉 SUCCESSFULLY BUILT ALL 96 MASTER HTML FILES BY TELECOM FUNCTIONAL AGENTS WITH SAFE PATHS!")
