...
v3_save_path = os.path.join(base_dir, "매뉴얼 BODY (집행단계)v3_지장물분류반영.xlsx")
...
# Load base v3 or v2
source_file = v3_path if os.path.exists(v3_path) else os.path.join(base_dir, "매뉴얼 BODY (집행단계)v2.xlsx")
...
print(f"\n🎉 Successfully saved updated workbook to '{v3_save_path}'")
