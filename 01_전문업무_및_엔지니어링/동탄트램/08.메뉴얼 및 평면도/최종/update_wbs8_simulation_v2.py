...
# =========================================================================
# WBS 8 STANDARD HTML (With Dual Horizontal & Vertical Interactive Simulators)
# =========================================================================
    ...
    <div class="p-6 sm:p-10 space-y-8">
        ...
        <div>
            ...
            <div class="bg-slate-100 border border-slate-300 rounded-2xl p-6">
                ...
                <!-- 수직 시뮬레이터 SVG 캔버스 -->
                <div class="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-inner relative" style="height: 260px;">
                    <svg viewBox="0 0 900 260" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                        <!-- 배경 그라데이션 -->
                        <defs>
                        ...
                        <!-- 도로 지면 -->
                        <rect x="0" y="210" width="900" height="50" fill="#475569"/>
                        <line x1="0" y1="210" x2="900" y2="210" stroke="#334155" stroke-width="3"/>
                        ...
                        <g transform="translate(150, 140)">
                            ...
                            <!-- 라벨 -->
                            <text x="230" y="47" text-anchor="middle" font-size="11" font-weight="bold" fill="#ffffff">장대레일 운반 트레일러 (적재단 최상고 H = 3.8m)</text>
                        </g>

                        <!-- 상부 지장물 그룹 (신호등 & 고압선) - JS에서 Y축 이동 -->
                        <g id="overheadObstacle" transform="translate(0, 0)">
                            <!-- 지장물 지지 지주 포스트 -->
                            <line x1="80" y1="0" x2="80" y2="210" stroke="#64748b" stroke-width="6"/>
                            <!-- 가로 신호등 Span arm -->
                            <line x1="80" y1="35" x2="520" y2="35" stroke="#64748b" stroke-width="4"/>
                            
                            <!-- 가로 신호등 기구 (H = 9.0m or H = 8.0m) -->
                            <rect x="360" y="25" width="60" height="20" rx="3" fill="#0f172a"/>
                            <circle cx="372" cy="35" r="5" fill="#ef4444"/>
                            <circle cx="390" cy="35" r="5" fill="#f59e0b"/>
                            <circle cx="408" cy="35" r="5" fill="#10b981"/>
                            <text x="390" y="18" text-anchor="middle" font-size="9" font-weight="bold" fill="#1e293b">교통신호등</text>
                            
                            <!-- 가공 고압 전선 지장물 (3선) -->
                            <line x1="0" y1="15" x2="900" y2="15" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="2 4"/>
                            <line x1="0" y1="20" x2="900" y2="20" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="2 4"/>
                            <text x="700" y="10" font-size="9" font-weight="bold" fill="#ef4444">한전 특고압 가공전선</text>
                        </g>

                        <!-- 이격거리 수직 치수선 (JS에서 좌표 갱신) -->
                        <g id="dimensionLine">
                            <!-- 수직선 화살표 -->
                            <line id="dimArrowLine" x1="390" y1="35" x2="390" y2="150" stroke="#0284c7" stroke-width="2"/>
                            <!-- 화살표 삼각 촉 -->
                            <polygon id="arrowTop" points="390,35 386,45 394,45" fill="#0284c7"/>
                            <polygon id="arrowBottom" points="390,150 386,140 394,140" fill="#0284c7"/>
                            <!-- 수치 라벨 배경 -->
                            <rect id="labelBg" x="405" y="80" width="130" height="26" rx="4" fill="#0284c7"/>
                            <text id="vertLabelText" x="470" y="97" text-anchor="middle" font-size="11" font-weight="bold" fill="#ffffff">이격거리 5.0m 확보</text>
                        </g>

                        <!-- 충돌 스파크/번개 이미지 효과 (Hidden by default) -->
                        <g id="sparkEffect" transform="translate(390, 110)" opacity="0" class="transition-opacity duration-200">
                            <polygon points="0,-20 10,-5 -5,5 15,25 0,10 10,-5" fill="#fbbf24" stroke="#d97706" stroke-width="2"/>
                            <circle cx="5" cy="5" r="25" fill="#fbbf24" opacity="0.3" class="animate-ping"/>
                            <text x="30" y="10" font-size="11" font-weight="black" fill="#dc2626">💥 아크 방전 및 접촉 충돌!</text>
                        </g>
                    </svg>
                </div>
            </div>
...
function setVertClearance(h) {
    ...
    if (h === 5) {
        ...
        // Adjust dimensions
        dimArrowLine.setAttribute('y1', '35');
        dimArrowLine.setAttribute('y2', '150');
        arrowBottom.setAttribute('points', '390,150 386,140 394,140');
        
        // Adjust label
        labelBg.setAttribute('y', '80');
        ...
        // Move obstacles down (simulating low wires/signal arm)
        obstacle.setAttribute('transform', 'translate(0, 30)');
        
        // Adjust dimensions
        dimArrowLine.setAttribute('y1', '65');
        dimArrowLine.setAttribute('y2', '150');
        arrowBottom.setAttribute('points', '390,150 386,140 394,140');
        
        // Adjust label
        labelBg.setAttribute('y', '95');
        labelBg.setAttribute('fill', '#dc2626');
        vertLabelText.innerText = "🚨 이격거리 4.0m 미달";
        
        // Show sparks & warnings
...
print("\n🎉 DUAL SIMULATORS (TURN & CLEARANCE) SUCCESSFULLY COMPILED!")
