...
print("=== Verification of Updated Plan Activity (Row 7) ===")
act_name = ws.cell(row=7, column=6).value
std_sum = ws.cell(row=7, column=19).value
gui_sum = ws.cell(row=7, column=21).value
chk_sum = ws.cell(row=7, column=23).value
