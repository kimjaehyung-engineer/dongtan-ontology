...
# =========================================================================
# WBS 8 CHECKLIST HTML (Highly Detailed & Aligned 100% to 10-Task Guidelines)
# =========================================================================
...
<div class="container">
    ...
    <div class="summary-box">
        ...
        <div style="font-weight: bold; line-height: 1.6;">장대레일 운반 트레일러(L&ge;25m) 회전반경 R=15m 시뮬레이션 승인, 상부 신호등/가공전선 이격 5m 이상 확보 및 가공 비계 간섭 배제 (10대 세부수칙 연동)</div>
    </div>
    ...
    <table>
        <thead>
            <tr style="background: #f1f5f9;">
                ...
                <th style="width: 67%;">예방할 품질 및 안전 리스크 위해 요소 (수행지침 1:1 매칭 검측사항)</th>
        ...
        <tbody>
            ...
            <tr class="pre-row">
                ...
                <td>
                    <div style="margin-bottom: 10px;">
                        <strong>• [1.1. 차량 제원 분석]</strong> 반입 차량(L&ge;25m, 중량 40t급)의 최소 회전 시 내륜차(Off-tracking) 기하 정보 사전 분석 여부
                    </div>
                    <div style="margin-bottom: 10px;">
                        <strong>• [1.2. 상부 지장물 수직 실측]</strong> 교통 신호기 및 한전 고압 가공선로와 수송 차량 간의 수직 <span class="term-highlight" onclick="openGlossary('clearance')">이격거리 5.0m 이상</span> 확보 여부 실측 검증
                    </div>
                    <div style="margin-bottom: 10px;">
                        <strong>• [1.3. 가설 지장물 간섭 조사]</strong> 선회 도로 곡선부 주변 타공종 <span class="term-highlight" onclick="openGlossary('scaffolding')">가공 비계</span>, 방호 펜스 등 간섭 한계 영역 실측 및 철거 범위 확인 여부
                    </div>
                    <div style="margin-bottom: 2px;">
                        <strong>• [1.4. 행정 인허가 조율]</strong> 경찰서 및 구청 도로과와 야간 차도 점용 구역 및 교통 통제 우회 계획 사전 승인서 확보 여부
                    </div>
                </td>
            ...
            <tr class="ing-row">
                ...
                <td>
                    <div style="margin-bottom: 10px;">
                        <strong>• [2.1. 시뮬레이션 의결]</strong> 대형 트레일러 회전 반경 <span class="term-highlight" onclick="openGlossary('rotation_radius')">R=15m</span> 확보 선회 시뮬레이션 결과서 최종 합동 승인 여부
                    </div>
                    <div style="margin-bottom: 10px;">
                        <strong>• [2.2. 통제 구역 마킹]</strong> 점용 차선 경계 부근 바리케이드, 안전 띠, 야간 신호 라바콘 설치 및 일반 차량 우회 싸인카 배치 완료 여부
                    </div>
                    <div style="margin-bottom: 10px;">
                        <strong>• [2.3. 전담 신호수 배치]</strong> 무전기를 소지한 전담 신호수 4명 이상을 교차로 4코너 및 반입 게이트에 밀착 배치하여 차량 진입 유도 통제 수행 여부
                    </div>
                    <div style="margin-bottom: 2px;">
                        <strong>• [2.4. 임시 지장비계 해제 및 속도 제어]</strong> 돌출 비계 철거 상태 육안 검증 및 반입 차량 진입 시 **시속 10km 이하** 초저속 주행 통제 규정 준수 여부
                    </div>
                </td>
                <td class="check-cell">☐ 확인완료</td>
            </tr>
            ...
            <tr class="post-row">
                ...
                <td>
                    <div style="margin-bottom: 10px;">
                        <strong>• [3.1. 도로 원상 복구]</strong> 차량 철수 즉시 통제 펜스를 전량 수거하고, 도로 노면 소성 변형이나 인도 경계석 파손 여부 점검 및 원상 복구 완료 여부
                    </div>
                    <div style="margin-bottom: 2px;">
                        <strong>• [3.2. 공학 데이터 영구 보존]</strong> 도로점용 완료서 및 **선회 궤적 검증이 수행된** 시뮬레이션 데이터를 영구 파일 대장화하여 본사 담당팀에 송부 완료 여부
                    </div>
                </td>
                <td class="check-cell">☐ 확인완료</td>
            </tr>
...
print("\n🎉 WBS 8 CHECKLIST 100% SYNCHRONIZED WITH 10-STEP OPERATIONAL GUIDELINES AND ENGINNERING TERMINOLOGY!")
