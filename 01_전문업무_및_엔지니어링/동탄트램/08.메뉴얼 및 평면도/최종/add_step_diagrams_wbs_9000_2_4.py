...
# GUIDELINE HTML (Step 1~5 1:1 2D Visual 그림 수록)
gui_html = f"""<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>동탄트램 통신분야 - 전기 / 신호 / 기계 / PSD / 차량 인터페이스 협의 수행지침서 (Step 1~5 1:1 그림 수록)</title>
...
<div class="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl border border-slate-200 overflow-hidden">
    <div class="bg-slate-900 text-white p-8 relative">
        <span class="bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase">Dongtan Tram Detailed Guideline (Step 1~5 1:1 그림 수록)</span>
            ...
            <div class="space-y-8 text-sm">
                ...
                <div class="bg-white p-6 rounded-2xl border border-blue-200 shadow-sm space-y-4">
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step1', 'STEP 1 KEC 33% 점유율 & 96Core 광케이블/ELP ø150mm 관로 2D 시공 도식')">
                        <svg id="svg_step1" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
                            <!-- 관로 프리캐스트 보호판 -->
                            <rect x="20" y="15" width="220" height="30" fill="#e2e8f0" stroke="#64748b" stroke-width="2" rx="4"/>
                            <text x="130" y="35" font-size="12" font-weight="black" fill="#334155" text-anchor="middle">📦 프리캐스트 콘크리트 보호판</text>
                            
                            <!-- ELP ø150mm 배관 6개 -->
                            <g transform="translate(20, 55)">
                                <circle cx="25" cy="25" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                                <circle cx="65" cy="25" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                                <circle cx="105" cy="25" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                                <circle cx="145" cy="25" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                                <circle cx="185" cy="25" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                                <text x="105" y="65" font-size="11" font-weight="bold" fill="#1e3a8a" text-anchor="middle">⚡ ELP ø150mm×6개×2조 (점유율 ≤ 33%)</text>
                            </g>

                            <!-- 96Core 광케이블 통합 포설 -->
                            <rect x="270" y="20" width="230" height="110" fill="#ffffff" stroke="#0284c7" stroke-width="2" rx="8"/>
                            <text x="385" y="45" font-size="13" font-weight="black" fill="#0369a1" text-anchor="middle">🌐 OF-SM-96Core×2조 통합 포설</text>
                            <text x="285" y="72" font-size="11" font-weight="bold" fill="#334155">• 통신 전송망: 48Core</text>
                            <text x="285" y="92" font-size="11" font-weight="bold" fill="#334155">• 전기 충전 원격감시: 4Core (2C×2조)</text>
                            <text x="285" y="112" font-size="11" font-weight="bold" fill="#334155">• 신호 전자연동장치: 16Core (8C×2조)</text>
                            <text x="285" y="132" font-size="11" font-weight="bold" fill="#0284c7">• 예비 코어(20% 이상): 28Core 확보</text>
                        </svg>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-indigo-200 shadow-sm space-y-4">
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step2', 'STEP 2 교차로 12m 강관주 Pole & CCTV/LTE-R 하중 검측 2D 시공 도식')">
                        <svg id="svg_step2" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
                            <!-- 12m 강관주 Pole -->
                            <line x1="80" y1="140" x2="80" y2="20" stroke="#475569" stroke-width="8"/>
                            <rect x="60" y="130" width="40" height="20" fill="#94a3b8" stroke="#334155" stroke-width="2"/>
                            ...
                            <!-- LTE-R RRU 안테나 -->
                            <rect x="84" y="60" width="30" height="25" fill="#0284c7" rx="3"/>
                            <text x="120" y="76" font-size="11" font-weight="black" fill="#0369a1">📡 LTE-R RRU 안테나</text>

                            <!-- CCTV 제어함체 (10kg) -->
                            <rect x="84" y="95" width="28" height="30" fill="#475569" rx="3"/>
                            <text x="120" y="114" font-size="11" font-weight="black" fill="#334155">🗄️ 제어함체 (10kg)</text>

                            <!-- 오른쪽 검측 조건 박스 -->
                            <rect x="250" y="20" width="250" height="120" fill="#ffffff" stroke="#4f46e5" stroke-width="2" rx="8"/>
                            <text x="375" y="45" font-size="13" font-weight="black" fill="#3730a3" text-anchor="middle">📷 12m Pole 공용화 구조 검측</text>
                            <text x="265" y="75" font-size="11" font-weight="bold" fill="#334155">• 12m 강관주 Pole 및 기초대 65개소</text>
                            <text x="265" y="98" font-size="11" font-weight="bold" fill="#334155">• 기초대 규격: M24x450mm 케미컬앵커</text>
                            <text x="265" y="121" font-size="11" font-weight="bold" fill="#4f46e5">• 풍하중 및 구조해석 계산서 승인</text>
                        </svg>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-cyan-200 shadow-sm space-y-4">
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step3', 'STEP 3 무가선 차량 30초 정차 충전 타임라인 & 차상 UPS 2D 시공 도식')">
                        <svg id="svg_step3" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
                            <!-- 트램 정차 30초 타임라인 -->
                            <rect x="20" y="20" width="480" height="60" fill="#ffffff" stroke="#0891b2" stroke-width="2" rx="8"/>
                            <text x="260" y="42" font-size="13" font-weight="black" fill="#0e7490" text-anchor="middle">⏱️ 정거장 30초 정차 정차역 급속충전 타임라인</text>
                            
                            <rect x="35" y="52" width="70" height="20" fill="#e0f2fe" stroke="#0284c7" stroke-width="1.5" rx="3"/>
                            <text x="70" y="66" font-size="10" font-weight="bold" fill="#0369a1" text-anchor="middle">5초: 상승</text>

                            <rect x="115" y="52" width="290" height="20" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5" rx="3"/>
                            <text x="260" y="66" font-size="11" font-weight="black" fill="#15803d" text-anchor="middle">⚡ 20초 급속 충전 (LTO 배터리 + 슈퍼캐패시터)</text>

                            <rect x="415" y="52" width="70" height="20" fill="#fee2e2" stroke="#dc2626" stroke-width="1.5" rx="3"/>
                            <text x="450" y="66" font-size="10" font-weight="bold" fill="#b91c1c" text-anchor="middle">5초: 하강출발</text>

                            <!-- 차상 무정전 전원 UPS 박스 -->
                            <rect x="20" y="95" width="480" height="50" fill="#ffffff" stroke="#0284c7" stroke-width="2" rx="8"/>
                            <text x="260" y="125" font-size="12" font-weight="black" fill="#0369a1" text-anchor="middle">🔋 차상 통신장치 & 차상 무선 안테나 무정전 전원공급(UPS) 1:1 결속 완료</text>
                        </svg>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-teal-200 shadow-sm space-y-4">
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step4', 'STEP 4 통합 UPS 10~20kVA 분전반 및 TPD 전원 수용 2D 시공 도식')">
                        <svg id="svg_step4" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
                            <!-- 통합 UPS 기계실 함체 -->
                            <rect x="30" y="20" width="180" height="120" fill="#ffffff" stroke="#0d9488" stroke-width="2" rx="8"/>
                            <text x="120" y="45" font-size="13" font-weight="black" fill="#0f766e" text-anchor="middle">🔋 통합 UPS 분전함</text>
                            <text x="45" y="75" font-size="11" font-weight="bold" fill="#334155">• 일반역사(25개소): 10kVA</text>
                            <text x="45" y="98" font-size="11" font-weight="bold" fill="#334155">• 연동역사(7개소): 20kVA</text>
                            <text x="45" y="121" font-size="11" font-weight="bold" fill="#0d9488">• 24시간 무정전 백업</text>

                            <path d="M 215 80 L 255 80" stroke="#0d9488" stroke-width="3"/>
                            <polygon points="255,75 265,80 255,85" fill="#0d9488"/>

                            <!-- 수용 장비 박스 -->
                            <rect x="270" y="20" width="220" height="120" fill="#ffffff" stroke="#059669" stroke-width="2" rx="8"/>
                            <text x="380" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">⚡ 무정전 전원 공급 장치</text>
                            <text x="285" y="75" font-size="11" font-weight="bold" fill="#334155">• 통신 전송/CCTV/PIS/PA 설비</text>
                            <text x="285" y="98" font-size="11" font-weight="bold" fill="#334155">• 신호 TPD 장치 전원 수용</text>
                            <text x="285" y="121" font-size="11" font-weight="bold" fill="#047857">• 돌발유고장치(500VA) 전원 수용</text>
                        </svg>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-emerald-200 shadow-sm space-y-4">
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl border border-slate-200 mt-3" onclick="openDiagramZoom('svg_step5', 'STEP 5 TTA 보안성 검증서 & 4자 배수 체결 2D 시공 도식')">
                        <svg id="svg_step5" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
                            <!-- TTA 서류 박스 -->
                            <rect x="25" y="20" width="220" height="120" fill="#ffffff" stroke="#059669" stroke-width="2" rx="8"/>
                            <text x="135" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">📄 TTA & KCA 검증 완료</text>
                            <text x="40" y="75" font-size="11" font-weight="bold" fill="#334155">• 무선통신 TTA 보안성/상호운용성</text>
                            <text x="40" y="98" font-size="11" font-weight="bold" fill="#334155">• KCA 전파 적합성 수수료 완료</text>
                            <text x="40" y="121" font-size="11" font-weight="bold" fill="#047857">• 법정 검수 서류 100% 확보</text>

                            <!-- 선로전환기 배수 4자 체결 박스 -->
                            <rect x="275" y="20" width="220" height="120" fill="#ffffff" stroke="#059669" stroke-width="2" rx="8"/>
                            <text x="385" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">🌧️ 선로전환기 4자 배수 체결</text>
                            <text x="290" y="75" font-size="11" font-weight="bold" fill="#334155">• 선로전환기: 노반 배수 파이프</text>
                            <text x="290" y="98" font-size="11" font-weight="bold" fill="#334155">• 차축검지기: 궤도/신호/토목 4자</text>
                            <text x="290" y="121" font-size="11" font-weight="bold" fill="#047857">• 5대 분야 서명 관리대장 등재</text>
                        </svg>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="clickable-diagram bg-slate-50 p-5 rounded-2xl border border-slate-200 shadow-inner" onclick="openDiagramZoom('svg_r4', '[WBS 9000-2-4] PDF 12대 시스템 인터페이스 2D Visual 도식')">
                <svg id="svg_r4" viewBox="0 0 550 180" width="100%" height="180" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="140" y="45" font-size="13" font-weight="black" fill="#1d4ed8" text-anchor="middle">🌐 96Core 광망 & KEC 33%</text>
                    <text x="40" y="75" font-size="11" font-weight="bold" fill="#334155">• OF-SM-96Core×2조 통합 포설</text>
                    <text x="40" y="98" font-size="11" font-weight="bold" fill="#334155">• ELP ø150mm×6개×2조 배관</text>
                    ...
                    <text x="417" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">📷 12m Pole 공용 & 통합 UPS</text>
                    <text x="325" y="75" font-size="11" font-weight="bold" fill="#334155">• 12m 강관주 65개소 공용화</text>
                    <text x="325" y="98" font-size="11" font-weight="bold" fill="#334155">• 통합 UPS 10~20kVA 배전</text>
                    <text x="275" y="162" font-size="13" font-weight="black" fill="#0f172a" text-anchor="middle">PDF 12대 시스템 인터페이스 회의록 및 1,2공구 종합 관리대장 완료</text>
                </svg>
            </div>
        </div>
    </div>
...
# CHECKLIST HTML (Step별 2D Visual 팝업 모달 수록)
...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div style="display:none;">
        <svg id="svg_chk_step1" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
            <rect x="20" y="15" width="220" height="30" fill="#e2e8f0" stroke="#64748b" stroke-width="2" rx="4"/>
            <text x="130" y="35" font-size="12" font-weight="black" fill="#334155" text-anchor="middle">📦 프리캐스트 콘크리트 보호판</text>
            <circle cx="45" cy="80" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
            <circle cx="85" cy="80" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
            <circle cx="125" cy="80" r="18" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
            <text x="125" y="125" font-size="11" font-weight="bold" fill="#1e3a8a" text-anchor="middle">⚡ ELP ø150mm (KEC 33%)</text>
            <rect x="270" y="20" width="230" height="110" fill="#ffffff" stroke="#0284c7" stroke-width="2" rx="8"/>
            <text x="385" y="45" font-size="13" font-weight="black" fill="#0369a1" text-anchor="middle">🌐 OF-SM-96Core×2조 통합 포설</text>
            <text x="285" y="75" font-size="11" font-weight="bold" fill="#334155">• 통신(48C) + 전기(4C) + 신호(16C)</text>
            <text x="285" y="100" font-size="11" font-weight="bold" fill="#0284c7">• 12m 강관주 65개소 공용화 도식</text>
        </svg>

        <svg id="svg_chk_step2" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
            <rect x="20" y="20" width="480" height="60" fill="#ffffff" stroke="#0891b2" stroke-width="2" rx="8"/>
            <text x="260" y="42" font-size="13" font-weight="black" fill="#0e7490" text-anchor="middle">⏱️ 무가선 차량 30초 정차 급속충전 인터페이스</text>
            <text x="260" y="65" font-size="11" font-weight="bold" fill="#15803d" text-anchor="middle">5초 상승 ➔ 20초 충전 ➔ 5초 하강 / 차상 UPS 1:1 결속</text>
            <rect x="20" y="95" width="480" height="50" fill="#ffffff" stroke="#0284c7" stroke-width="2" rx="8"/>
            <text x="260" y="125" font-size="12" font-weight="black" fill="#0369a1" text-anchor="middle">🔋 이격거리 ≥300mm & TTA 무선통신 보안성 검증서확인</text>
        </svg>

        <svg id="svg_chk_step3" viewBox="0 0 520 160" width="100%" height="160" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" y="0" width="520" height="160" fill="#f8fafc"/>
            <rect x="25" y="20" width="220" height="120" fill="#ffffff" stroke="#059669" stroke-width="2" rx="8"/>
            <text x="135" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">📻 PSD 비상통화 3초 연동</text>
            <text x="40" y="75" font-size="11" font-weight="bold" fill="#334155">• 스크린도어 버튼 1:1 시험</text>
            <text x="40" y="100" font-size="11" font-weight="bold" fill="#047857">• PA/PIS 방송 지연 ≤ 0.5초</text>

            <rect x="275" y="20" width="220" height="120" fill="#ffffff" stroke="#059669" stroke-width="2" rx="8"/>
            <text x="385" y="45" font-size="13" font-weight="black" fill="#047857" text-anchor="middle">🌧️ 선로전환기 4자 배수 체결</text>
            <text x="290" y="75" font-size="11" font-weight="bold" fill="#334155">• 선로전환기 & 차축검지기 배수</text>
            <text x="290" y="100" font-size="11" font-weight="bold" fill="#047857">• 5자 서명 종합대장 등재 완료</text>
        </svg>
    </div>
        ...
        for fn in os.listdir(sp):
            if fn.endswith('.html'):
                with open(os.path.join(sp, fn), 'w', encoding='utf-8') as f_out:
                    f_out.write(content)
                print(f"   ✓ [ADDED STEP 1~5 2D DIAGRAMS] {s_n} -> {fn}")

print("\n🎉 SUCCESSFULLY INSERTED STEP 1~5 1:1 2D VISUAL DIAGRAMS INTO GUIDELINE AND CHECKLIST HTMLs!")
