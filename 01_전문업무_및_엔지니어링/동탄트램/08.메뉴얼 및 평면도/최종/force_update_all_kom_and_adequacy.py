...
# HTML Contents for WBS 9000-2-2 발주전략 KOM
kom_std_html = """<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div style="margin-bottom: 4px;">
                        <span class="step-tag" style="background:#e0e7ff; color:#3730a3;">8. 창고 비용</span>
...
# Scan all folders matching '1_' or '2_' or '설계적정성' or 'KOM'
...
for folder in os.listdir(base_dir):
    ...
    # Process WBS 9000-2-2 KOM folders
    if 'KOM' in folder or '2_' in folder or '9000-2-2' in folder:
                    ...
                    if f.endswith('.html'):
                        ...
                        if '표준서' in sub:
                            with open(file_path, 'w', encoding='utf-8') as out:
                                out.write(kom_std_html)
                        elif '수행지침' in sub:
                            with open(file_path, 'w', encoding='utf-8') as out:
                                out.write(kom_gui_html)
                        elif '체크리스트' in sub:
                            with open(file_path, 'w', encoding='utf-8') as out:
                                out.write(kom_chk_html)
                        updated_files_count += 1
                        print(f"OVERWROTE KOM HTML: {file_path}")

print(f"\n🎉 FORCE OVERWROTE {updated_files_count} KOM HTML FILES ACROSS ALL DIRECTORY VARIANTS!")
