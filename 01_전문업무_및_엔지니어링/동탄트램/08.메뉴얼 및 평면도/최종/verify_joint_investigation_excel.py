...
print("=== Verification of Updated Joint Investigation Activity (Row 6) ===")
act_name = ws.cell(row=6, column=6).value
std_sum = ws.cell(row=6, column=19).value
gui_sum = ws.cell(row=6, column=21).value
chk_sum = ws.cell(row=6, column=23).value
