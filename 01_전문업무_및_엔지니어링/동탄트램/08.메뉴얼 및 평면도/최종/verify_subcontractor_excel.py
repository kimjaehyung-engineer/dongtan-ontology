...
print("=== Verification of Updated Subcontractor Selection Activity (Row 5) ===")
act_name = ws.cell(row=5, column=6).value
std_sum = ws.cell(row=5, column=19).value
gui_sum = ws.cell(row=5, column=21).value
chk_sum = ws.cell(row=5, column=23).value
