...
gui_optical_hedge_html = f"""<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<div class="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl border border-slate-200 overflow-hidden">
    <div class="bg-slate-900 text-white p-8 relative">
        ...
        <p class="text-blue-200 text-sm mt-1">L4 Code: 9000-2-7 | 주관: 현장 시스템팀 / 통신 감리단 | "72-Core 광 접속 & 헷지방안 완벽 수록"</p>
    </div>
    ...
    <div class="p-6 sm:p-10 space-y-10">
        ...
        <div class="space-y-8">
            ...
            <div class="space-y-8 text-sm">
                ...
                <!-- STEP 2 HOW + VISUAL SVG (72-Core 광 접속 & 헷지방안 초심자 해설 수록) -->
                <div class="bg-white p-6 rounded-2xl border border-indigo-200 shadow-sm space-y-4">
                    ...
                    <!-- 📖 초심자를 위한 72-Core 광 접속의 의미, 불량 시 하자 위험, 접속 손실 원인 및 헷지 방안 해설 박스 -->
                    ...
                    <div class="bg-slate-50 p-5 rounded-xl text-xs text-slate-700 space-y-3 leading-relaxed border border-slate-200">
                        <p><strong>💡 핵심 실무 지침:</strong></p>
                        <ul class="list-disc pl-5 space-y-1.5 text-slate-800">
                            <li><strong>광 접속 검측:</strong> 72-Core 메인 광케이블 융착 접속 완료 후, <span class="term-highlight" onclick="openGlossary('OTDR')">OTDR</span>(광파동 측정기) 및 광파워미터(1310/1550nm)를 통해 측정합니다.</li>
...
for fn in os.listdir(gui_folder):
    if fn.endswith('.html'):
        ...
        with open(fp, 'w', encoding='utf-8') as f:
            f.write(gui_optical_hedge_html)
        print(f"   ✓ [STEP 2 OPTICAL HEDGE GLOSSARY ADDED] Guideline -> {fn}")

print("\n🎉 SUCCESSFULLY ADDED STEP 2 OPTICAL SPLICING & HEDGE PLAN EXPLANATIONS TO WBS 9000-2-7 GUIDELINE HTMLs!")
