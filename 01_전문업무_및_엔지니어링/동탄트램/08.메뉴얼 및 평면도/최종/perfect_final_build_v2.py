...
# =========================================================================
# 2. COMPILE GUIDELINE HTML (No Duplicate NDT links, NO Welding Process Button)
# =========================================================================
...
<div class="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl border border-slate-200 overflow-hidden">
        ...
        <div>
            ...
            <div class="space-y-6 relative pl-6 border-l-4 border-emerald-500">
                ...
                <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm relative">
                    ...
                    <h3 class="text-base font-bold text-slate-900 mt-2 mb-2">NDT 비파괴검사, 1m 직선도 측정 및 장대레일 반출 <span class="scene-link" onclick="openScene('launching')">📸 인입(Launching) 보기</span></h3>
                    <ul class="space-y-1.5 text-xs sm:text-sm text-slate-600 list-disc list-inside">
    ...
    <div class="bg-slate-900 text-slate-400 p-6 text-center text-xs border-t border-slate-800">
        동탄도시철도(트램) 건설공사 엔지니어링 수행지침서 | WBS 9000-6-3 | 궤도공학 콘크리트도상
    </div>
</div>
...
print("\n🎉 PERFECT INTEGRATED WELDING FILES ASSEMBLED AND WRITTEN CLEANLY!")
