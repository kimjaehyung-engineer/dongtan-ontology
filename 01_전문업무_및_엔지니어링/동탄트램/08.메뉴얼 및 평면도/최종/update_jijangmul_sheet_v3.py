...
# 38 Detailed Jijangmul Activities extracted from new enlarged process map images
jijangmul_activities_v3 = [
    # Section A: 사전준비 및 Risk 검토 (확장)
    {
        ...
        "mtd": "설계도서 불일치 구간 실행예산 변경 여부 검토 및 설계변경 불가시 Risk 최소화 방안 검토 (참석: 현장/견적/설계/업체 Pool 우수 토공업체)",
        "del": "Site Survey 검토서",
    ...
    },
    {
        ...
        "act": "발주전략 KOM (도급지분)", "own": "현장소장",
        "gol": "도급자 지장물 이설 업체 선정 및 위수탁기관 협의 검토",
        "mtd": "직영분/외주분 구분 검토, 현설조건 검토, 장비 Requirement 검토, 공법 및 공기 검토 (지원: 본사외주부서, 수행부서, 토목국내견적팀, 컴플라이언스RM팀)",
        "del": "KOM 검토보고서, 협설서 (하자방지 특기조건 포함)",
        "std_sum": "1) CML 토목사무지침 준수 및 도급 지장물 이설 전문업체 적격 검토\n2) 직영/외주 구분 및 발주 전 구조안전성/공기 타당성 100% 확보",
        "gui_sum": "1) 도급자 이설분 이설업체 계약 시 하자방지 특기시방 조건 명시\n2) 장비 Requirement 및 컴플라이언스 RM 검토 수칙 이행",
        "chk_sum": "1) KOM 검토보고서 및 협설서 특기조건 반영 여부를 확인했는가?\n2) 이설 전문업체 계약 전 시공 능력 및 장비 사양을 검측했는가?",
        "disc": "지장물이설", "des": "CML 토목사무지침 및 도급 계약 시방", "risk": "부적격 업체 선정에 따른 공기 지연 리스크 방지", "sub": "본사외주부서 및 컴플라이언스RM 자문"
    },
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-3", "dday": "P+0",
        "act": "지장물 이설 요청 (위수탁고)", "own": "공사팀 / 발주기관",
        "gol": "위수탁기관 지장물 이설 착수 공문 발송",
        "mtd": "양질의 위수탁기관 협의를 통한 발주기관 위수탁 지장물 정식 이설 요청 (참석: 공사팀, 발주기관)",
        "del": "지장물 이설요청 공문",
        "std_sum": "1) 위수탁기관별 관련 법령에 따른 이설 착수 요청 공문 정식 발송\n2) 발주기관 연계 이설 범위 및 예산 분담 범위 명시",
    ...
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-4", "dday": "P+5",
        "act": "도급자분 이설업체 선정(상/하수)", "own": "현장소장",
        "gol": "상하수도 도급자분 이설공사 수행을 위한 적격 하도급업체 선정",
        "mtd": "유관기관 협의 결과 및 설계변경 진행 연계, 시공/수행/견적/계약 합동 평가",
        "del": "지장물 이설 하도급업체 선정서",
        "std_sum": "1) 상하수도 이설 전문면허 보유 업체 하도급 적격 심사 85점 이상 달성\n2) 설계변경 반영 물량 및 공사 수행 능력 100% 검증",
        "gui_sum": "1) 하도급 계약 시 이설 수밀 시험 및 안전 시방 조항 명시\n2) 외주계약팀 승인 후 최종 이설 하도급 계약 체결",
        "chk_sum": "1) 상하수도 이설 전문업체 적격 심사표 및 계약서를 확인했는가?\n2) 현장 대리인 및 필수 배관 기술자 배치 여부를 검측했는가?",
        "disc": "지장물이설", "des": "하도급거래 공정화에 관한 법률 및 계약 규정", "risk": "저가 하도급으로 인한 부실 시공 리스크 예방", "sub": "외주계약팀 전문 자문"
    },
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-5", "dday": "P+10",
        "act": "지장물 조사 (위탁기관 합동)", "own": "현장 공사팀",
        "gol": "설계도서와 지장물 관리기관 도면 일치 및 현장 맨홀 위치 재확인",
        "mtd": "수행/견적/계약/발주기관/유관부서/지장물이설업체 합동 현장 줄탐지 및 맨홀 확인",
        "del": "착공전 측량보고서, 현장 조사 보고서 (민원 포함)",
        "std_sum": "1) 관리기관 지장물 도면과 실제 현장 맨홀/밸브 위치 100% 현장 대조\n2) 착공 전 측량 성과표 및 인접 주민 민원 우려 요소 사전 도출",
        "gui_sum": "1) 유관기관 감독관 및 이설업체 기술자 현장 동행 조사\n2) 위치 일치 여부 현장 조사 보고서 및 사진대지 작성",
        "chk_sum": "1) 위탁기관 합동 현장 조사 보고서 및 측량보고서를 확인했는가?\n2) 현장 맨홀 및 노출 관로 심도 일치 여부를 검측했는가?",
        "disc": "지장물이설", "des": "지하안전관리에 관한 특별법 및 측량 규정", "risk": "도면 상이로 인한 신규 지장물 불시 도출 리스크 방지", "sub": "지장물 이설업체 및 유관기관 담당자"
    },
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-6", "dday": "P+15",
        "act": "지장물 이설 계획 수립", "own": "현장 공사팀",
        "gol": "인허가, 교통처리대책, 이설 설계 기준 및 시공방법 종합 수립",
        "mtd": "공사/공무/발주기관/유관기관/지장물 이설업체 협의 (우선순위, 이격거리 확정)",
        "del": "지장물 이설 종합계획서 (우선순위, 이격거리, 시공방법 포함)",
        "std_sum": "1) 트램 궤도 구조물과 지장물 수평/수직 최소 이격거리(1.5m 이상) 확보\n2) 관종별 이설 우선순위(상하수 ➔ 가스 ➔ 전력/통신) 확정 준수",
        "gui_sum": "1) 인허가 및 교통처리 대책과 연계된 릴레이 이설 일정 수립\n2) 이설계획서 감리단 및 발주기관 정식 승인 수칙",
        "chk_sum": "1) 지장물 이설 종합계획서 및 이격거리 적정성을 확인했는가?\n2) 감리단 승인서 및 관종별 시공 순서 타당성을 검측했는가?",
        "disc": "지장물이설", "des": "동탄트램 지장물 이설 종합 지침", "risk": "이설 순서 혼선으로 인한 재굴착 리스크 방지", "sub": "지장물 전문가 및 공무팀"
    },
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-7", "dday": "P+20",
    ...
    {
        "l3_code": "2000-1", "l3_name": "공통 관리 Key Point & 사전 준비", "l4_code": "2000-1-8", "dday": "D-60",
    ...
    {
        "l3_code": "2000-1S", "l3_name": "사전준비: 공동 대응 방안 수립", "l4_code": "2000-1S-1", "dday": "D-50",
        "act": "인허가 절차 진행", "own": "현장 공무팀",
        "gol": "공사 진행에 따른 인허가 절차 적기 시행",
        "mtd": "용지도 확인 및 공사 구간 내 인허가 필요 구간 확인 ➔ 기관별 승인 접수",
        "del": "인허가 항목별 승인서 및 협의 공문",
        "std_sum": "1) 공사 구간 내 법정 인허가(도로점용, 하천점용, 구거사용 등) 100% 도출\n2) 착공 30일 전 인허가 신청서 정밀 제출 및 승인 획득",
        "gui_sum": "1) 인허가 조건부 승인 사항 현장 이행 관리대정 기록\n2) 점용료 및 사용료 사전 정산 수칙 준수",
        "chk_sum": "1) 인허가 항목별 승인서 획득 여부를 확인했는가?\n2) 허가 조건 이행 대장 작성 적정성을 검측했는가?",
        "disc": "지장물이설", "des": "인허가 관련 행정법 및 도로법", "risk": "인허가 지연으로 인한 공사 중단 리스크 방지", "sub": "인허가 전문 자문"
    },
    {
        "l3_code": "2000-1S", "l3_name": "사전준비: 공동 대응 방안 수립", "l4_code": "2000-1S-2", "dday": "D-45",
        "act": "교통처리대책 협의 및 승인", "own": "현장 공무팀/안전팀",
        "gol": "운영기간, 필요물량, 임대비용 적정성 검토 및 교통 승인",
        "mtd": "사토장/토취장 list-up 및 관련 L/L과 고자검토 ➔ 경찰서 및 관청 교통협의",
        "del": "교통처리대책 심의 승인서 (운영 원가/안전/품질 Risk 도출)",
        "std_sum": "1) 경찰서 교통안전시설 심의 승인 및 가변차로 운용 규정 준수\n2) 사토장/토취장 덤프트럭 운행 동선 안전 수칙 적용",
        "gui_sum": "1) 교통 우회 안내 표지판 설치 및 신호 유도원 배치\n2) 출퇴근 시간대 차선 통제 최소화 관리 수칙",
        "chk_sum": "1) 경찰서 교통처리대책 심의 승인서를 확인했는가?\n2) 임시 교통안전 시설물 적정성을 검측했는가?",
        "disc": "지장물이설", "des": "도로교통법 및 교통영향평가 지침", "risk": "교통 혼잡민원 및 안전사고 발생 리스크 예방", "sub": "교통영향평가 전문 기술자"
    },
    {
        "l3_code": "2000-1S", "l3_name": "사전준비: 공동 대응 방안 수립", "l4_code": "2000-1S-3", "dday": "D-40",
        "act": "민원 저감 대책 수립", "own": "현장 공무팀/민원팀",
        "gol": "민원으로 인한 공사 지연 및 지장 사전 방지",
        "mtd": "민원우려 지역 주민 면담, 소음/진동/소독 요구사항 정리 및 사전 안내",
        "del": "민원 저감대책 수립 및 이행보고서",
        "std_sum": "1) 현장 소음/진동 법정 기준(소음 65dB 이하) 준수 방음벽 설치\n2) 작업 전 인접 상가 및 주민 대상 사전 공사 안내문 현장 배포",
        "gui_sum": "1) 24시간 민원 전용 창구 가동 및 민원 처리 이력서 기록\n2) 살수차 상시 가동으로 비산먼지 민원 차단 수칙",
        "chk_sum": "1) 주민 현장 설명회 실시 및 안내문 배포 여부를 확인했는가?\n2) 소음/진동 저감 대책 및 살수차 가동을 검측했는가?",
        "disc": "지장물이설", "des": "환경보전법 및 소음진동관리법", "risk": "집단 민원에 따른 현장 봉쇄 및 집회 리스크 방지", "sub": "민원 전담 현장 대리인"
    },
    {
        "l3_code": "2000-1S", "l3_name": "사전준비: 공동 대응 방안 수립", "l4_code": "2000-1S-4", "dday": "D-35",
        "act": "용지보상 Risk 파악", "own": "현장 공무팀 / 토목계약관리팀",
        "gol": "용지 보상 지연에 따른 공정 지연 문제점 사전 도출",
        "mtd": "미보상 용지 표시 및 용지 보상 시기 확인 ➔ 기공승낙 합의서 획득",
        "del": "용지보상 현황표 및 미보상 용지 Risk 검토서",
        "std_sum": "1) 트램 궤도 및 지장물 이설 구간 토지 보상 100% 사전 점검\n2) 미보상 토지 진입 금지 경계 표지판 및 현황도 현치 준수",
        "gui_sum": "1) 지자체 토지보상과 수시 협의로 보상 일정 독촉\n2) 미보상 토지 우회 시공 가능 여부 사전 타당성 검토",
        "chk_sum": "1) 용지보상 현황표 작성 및 미보상 구역 표시를 확인했는가?\n2) 기공승낙서 획득 및 보상 완료 여부를 검측했는가?",
        "disc": "지장물이설", "des": "토지보상법 및 용지 보상 조례", "risk": "사유지 무단 침범에 따른 형사 고소 리스크 방지", "sub": "토지 보상 전문 행정사 자문"
    },
    ...
    {
        "l3_code": "2000-6", "l3_name": "공사 선행/후행 공종 요구사항 연계", "l4_code": "2000-6-1", "dday": "D-90",
        "act": "공사전 선행공종에서 인수받을 사항", "own": "현장 사업단 / 공무팀",
        "gol": "지장물 이설 착수 전 선행 조사 및 용지 보상 완료 인수",
        "mtd": "지장물 조기 조사 결과, 미보상 용지 확보 현황 및 사전 인허가 승인 공문 인수",
        "del": "선행 공종 인수인계서 및 부지 인수 확인서",
        "std_sum": "1) 선행 조사 지장물 데이터 및 미보상 용지 현황 100% 인수\n2) 인허가 완료 공문 및 유관기관 협의록 접수",
        "gui_sum": "1) 인수 부지 경계 정밀 재측량 및 무단 점유 여부 확인\n2) 인수 항목 체크리스트 서명 후 지장물 이설 팀 전달 수칙",
        "chk_sum": "1) 선행 공종 지장물 조사 보고서 및 인허가 공문 인수를 확인했는가?\n2) 용지 보상 인수 확인서 날인 여부를 검측했는가?",
        "disc": "지장물이설", "des": "선후행 공종 인수인계 규정", "risk": "선행 인수 미비로 인한 이설 중단 리스크 방지", "sub": "선행 공종 책임 감리원"
    },
    {
        "l3_code": "2000-6", "l3_name": "공사 선행/후행 공종 요구사항 연계", "l4_code": "2000-6-2", "dday": "D+100",
        "act": "공사중 챙겨야할 후행공종의 요구사항", "own": "현장 공사팀 / 강화노반팀",
        "gol": "지장물 이설 완공 후 후행 노반/궤도 공종 정밀 인수 인계",
        "mtd": "강화노반/궤도 타설 전 지장물 이설 완공 및 관로 수밀 시험 완료 검측서 인계",
        "del": "후행 공종(강화노반) 인계서 및 준공도",
        "std_sum": "1) 지장물 이설 완공 후 강화노반 반력계수(K30 ≥ 110 MN/m³) 확보\n2) 지장물 위치 준공도서 후행 궤도/건축 시공 팀 인계 100%",
        "gui_sum": "1) 후행 공종 간섭 관로 매설 심도(H ≥ 1.5m) 재검증\n2) 인계인수 시 감리단 및 후행 공사팀 현장 참관 수칙 준수",
        "chk_sum": "1) 지장물 완공 후 강화노반 공정 인계서 작성을 확인했는가?\n2) 후행 궤도 시공팀 준공도서 인계 및 확인 서명을 검측했는가?",
        "disc": "지장물이설", "des": "후행 공종 연계 인계 지침", "risk": "후행 궤도 시공 시 신규 이설 관로 재간섭 리스크 방지", "sub": "후행 강화노반 및 궤도 기술사"
    }
]

print(f"Defined {len(jijangmul_activities_v3)} detailed Jijangmul engineering activities for v3 update.")
...
for idx, act in enumerate(jijangmul_activities_v3, start=1):
...
<div class="container">
    <div class="header">
        ...
        <div class="meta-info">
            <span><strong>공종/분야:</strong> 지장물이설 / {act.get('disc', '지장물이설')}</span>
            <span>|</span>
...
print(f"Successfully generated {html_created} HTML files across {len(jijangmul_activities_v3)} Jijangmul activity folders.")

# Step 3. Write into '지장물이설' sheet in Excel v3
print("\nUpdating '지장물이설' sheet in v3 Excel...")
...
ws.column_dimensions['C'].width = 32 # L3 Name
...
# Populate Data Rows
for r_idx, act in enumerate(jijangmul_activities_v3, start=2):
    sanitized_act = sanitize_name(act['act'])
    ...
    # 17: Disc
    ws.cell(row=r_idx, column=17, value=f"사전토공·{act.get('disc', '지장물이설')}").alignment = align_center
    # 18: Des
...
print(f"Successfully populated {len(jijangmul_activities_v3)} rows into '지장물이설' sheet.")

# Step 4. Save workbook as v3 (업데이트 저장 - v3)
wb_v3.save(v3_save_path)
print(f"\n🎉 Successfully updated v3 workbook at '{v3_save_path}'")
