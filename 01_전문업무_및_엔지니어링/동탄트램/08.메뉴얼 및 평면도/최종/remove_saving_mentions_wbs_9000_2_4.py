        ...
        for fn in os.listdir(sp):
            if fn.endswith('.html'):
                with open(os.path.join(sp, fn), 'w', encoding='utf-8') as f_out:
                    f_out.write(content)
                print(f"   ✓ [REMOVED SAVING MENTIONS WBS 9000-2-4] {s_n} -> {fn}")

print("\n🎉 SUCCESSFULLY REMOVED ALL COST SAVING MENTIONS FROM WBS 9000-2-4 HTML FILES!")
