...
for act in activities:
    ...
    # Standard HTML (Pure Engineering Standard without Agent labels)
...
"""
    ...
    # Guideline HTML (Pure Engineering Guideline without Agent labels)
...
"""
    ...
    # Checklist HTML (~하였는가? 어미 100%, Agent labels removed)
...
print("\n🎉 SUCCESSFULLY BUILT ALL 96 CLEAN MASTER HTML FILES WITHOUT AGENT LABELS!")
