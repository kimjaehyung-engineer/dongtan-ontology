...
# Find actual existing folders in base_dir
...
for act in activities:
    ...
    # Locate exact target folder matching activity index or name
    ...
    <div class="bg-slate-900 text-white p-8 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-3 mb-2">
                ...
                <span class="bg-white text-slate-950 text-xs font-bold px-3 py-1 rounded-full">정보통신공사업법 / KCS 47 10 00 준수</span>
            </div>
    ...
    <div class="p-6 sm:p-10 space-y-10">
        <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl">
            ...
            <p class="text-sm text-blue-900 leading-relaxed">
                본 표준서는 동탄도시철도(트램) 통신분야 [{name}] 공종의 품질 및 시공 무결성을 확보하기 위해 수립된 공학 시방 표준 규정입니다. (주관: {dept})
            </p>
        </div>
    ...
    <div class="bg-slate-900 text-white p-8 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-3 mb-2">
                ...
                <span class="bg-white text-slate-950 text-xs font-bold px-3 py-1 rounded-full">통신 3단계 visual 수행 지침서</span>
            </div>
            ...
            <div class="space-y-8 relative pl-6 border-l-4 border-emerald-500">
                ...
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-md relative space-y-4">
                    ...
                    <p class="text-slate-600 text-xs sm:text-sm leading-relaxed">
                        시공 착수 전 설계 적정성, 사양서, 자재공급원을 승인하고 토목/건축/전기/신호 분야와의 <span class="term-highlight" onclick="openGlossary('optical_backbone')">통신 백본망 및 슬리브 사전 인터페이스</span>를 검증합니다.
                    </p>
                    ...
                    <div class="clickable-diagram bg-slate-50 p-4 rounded-xl flex justify-center items-center shadow-inner border border-blue-200" onclick="openDiagramZoom('svgStep1_Card', '[사전 준비] {name} 사전 도면 및 인터페이스 대조 도면')">
                        <svg id="svgStep1_Card" viewBox="0 0 520 180" width="100%" height="180" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <text x="380" y="105" font-size="12" font-weight="bold" fill="#059669" text-anchor="middle">토목/건축/전기/신호 연동</text>
                        </svg>
                    </div>
                </div>
...
<div class="container">
    <div class="header">
        ...
        <span class="meta">WBS Code {code} | 통신 검측대장</span>
    </div>
    ...
    <div style="text-align: center; font-size: 0.85rem; color: #94a3b8; margin-top: 30px; border-top: 1px solid #e2e8f0; padding-top: 15px;">
        동탄도시철도(트램) 건설공사 | WBS {code} {name} 마스터 체크리스트
    </div>
</div>
{common_modal_html}
</body>
...
"""
    ...
    # Save HTML files in target folder
...
print("\n🎉 SUCCESSFULLY BUILT ALL 96 HTML MASTER FILES FOR TELECOM 32 ACTIVITIES!")
