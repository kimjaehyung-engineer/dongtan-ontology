...
bigroom_super_std = """<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="svg-container">
        <svg viewBox="0 0 900 340" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="450" y="32" text-anchor="middle" font-size="16" font-weight="bold" fill="#0f172a">착수전 Big Room 3D BIM 간섭 검증 및 기관 공정 조율 절차</text>

            <!-- Box 1 -->
            <g transform="translate(30, 55)">
                <rect width="180" height="195" rx="8" fill="#ffffff" stroke="#2563eb" stroke-width="2"/>
                <rect width="180" height="38" rx="8" fill="#dbeafe"/>
                <text x="90" y="24" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e40af">① 3D BIM 간섭 검증</text>
                
                <text x="14" y="65" font-size="11" font-weight="bold" fill="#0f172a">• 5대 관종 3D 통합 모델</text>
                <text x="14" y="88" font-size="11" fill="#334155">• 궤도 이격 H≥1.5m 검증</text>
                <text x="14" y="111" font-size="11" fill="#334155">• 3D Clash Zero 달성</text>
                <text x="14" y="134" font-size="11" fill="#2563eb" font-weight="bold">• 사전 간섭 충돌 배제</text>
            </g>
            ...
            <g transform="translate(245, 55)">
                ...
                <text x="95" y="24" text-anchor="middle" font-size="13" font-weight="bold" fill="#9a3412">② 기관 공정 동시조율</text>

                <text x="14" y="65" font-size="11" font-weight="bold" fill="#0f172a">• 전력(255일)/광역(160일)</text>
                <text x="14" y="88" font-size="11" fill="#334155">• 통신(150일)/가스(62일)</text>
                <text x="14" y="111" font-size="11" fill="#334155">• Critical Path 조율</text>
                <text x="14" y="134" font-size="11" fill="#ea580c" font-weight="bold">• 동시 굴착 중복 방지</text>
            </g>
            ...
            <g transform="translate(470, 55)">
                ...
                <rect width="190" height="38" rx="8" fill="#dcfce7"/>
                <text x="95" y="24" text-anchor="middle" font-size="13" font-weight="bold" fill="#15803d">③ 인허가 패스트트랙</text>

                <text x="14" y="65" font-size="11" font-weight="bold" fill="#0f172a">• 도로점용/굴착 심의 서류</text>
                <text x="14" y="88" font-size="11" fill="#334155">• 경찰서 교통 심의 작성</text>
                <text x="14" y="111" font-size="11" fill="#334155">• 14일 전 사전 통합 제출</text>
                <text x="14" y="134" font-size="11" fill="#059669" font-weight="bold">• 인허가 승인 단축</text>
            </g>
            ...
            <g transform="translate(695, 55)">
                ...
                <text x="87" y="24" text-anchor="middle" font-size="13" font-weight="bold" fill="#1e1b4b">④ Big Room 서명 의결</text>

                <text x="14" y="65" font-size="11" font-weight="bold" fill="#0f172a">• 발주처-위탁기관 체결</text>
                <text x="14" y="88" font-size="11" fill="#334155">• 48시간 핫라인 구축</text>
                <text x="14" y="111" font-size="11" fill="#334155">• 착수전 의결서 서명</text>
                <text x="14" y="134" font-size="11" fill="#1e3a8a" font-weight="bold">• 착수 준비 완결</text>
            </g>

            <rect x="30" y="270" width="840" height="48" rx="8" fill="#1e3a8a"/>
            <text x="450" y="299" text-anchor="middle" font-size="13" font-weight="bold" fill="#ffffff">🚨 착수전 Big Room 회의 미개최 시 지하 3D 간섭 및 기관 간 공정 충돌 재난 전면 차단</text>
        </svg>
    </div>
        ...
        for f in os.listdir(sub_std):
            if f.endswith('.html'):
                ...
                with open(fp, 'w', encoding='utf-8') as out:
                    out.write(bigroom_super_std)
                print(f"  ✅ Super Rich Big Room Standard Overwritten: {fp}")

print("🎉 Complete Super Rich Big Room Standard HTML Overwrite!")
